...
//            printf("c h w num_cls num_anchors: %d %d %d %d %d\n", feat_c, feat_h, feat_w, num_classes, num_anchors);
        ...
        static inline float softmax(const float* src, float* dst, int length)
        {
        ...
        static inline void generate_proposals_yolov8_native(int stride, const float* feat, float prob_threshold, std::vector<Object>& objects,
